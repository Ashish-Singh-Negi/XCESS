...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      className={`min-h-[740px] sm:min-h-[800px] lg:min-h-[1024px] w-full rounded-b-3xl sm:rounded-none bg-center bg-cover bg-no-repeat pt-[72px] md:pt-28 flex items-end sm:items-center`}
    >
