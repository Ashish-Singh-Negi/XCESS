    ...
    <>
      {payment ? (
        ...
        <>
          ...
          <div className="w-full md:w-[952px] md:mt-4">
          ...
          <section className="md:h-28 w-full md:w-[80%] flex flex-col sm:flex-row sm:justify-between md:mt-16">
            <CouponCard />
            <div className="md:h-28 md:w-[362px] border-[1px] border-[#C3C3C3] py-4 rounded-2xl shadow-md mt-8 md:my-8">
              <div className="h-full grid grid-cols-3">
                <p className="text-xs sm:text-lg flex flex-col border-r-[1px] border-[#A6A6A6] text-center">
                  Freight Charge
                ...
                <p className="text-xs sm:text-lg flex flex-col text-center">
                  Total Amount
          ...
          <section className="w-full md:w-[80%] border-[1px] border-[#CACACA] rounded-2xl px-4 md:px-10 py-2 md:py-6 flex justify-between items-center">
