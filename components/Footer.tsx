...
const Footer = () => {
  return (
    <footer className="w-full py-16 sm:py-20 md:py-24 bg-[#2B2A29]">
      <div className="mx-4 sm:mx-8 md:mx-[60px] lg:mx-[120px] flex flex-col lg:flex-row justify-between sm:py-20 md:py-24 gap-12 sm:border-b-2 border-[#606060] ">
        <div className=" lg:w-[268px]">
          <Image
            ...
            height={104}
            width={268}
            className="h-[72px] w-[140px] sm:h-[120px] md:w-[268px] sm:mx-auto lg:mx-0"
          />
          <div className="h-[52px] w-full flex gap-4 sm:gap-6 lg:gap-8 pl-4 sm:pl-6 lg:pl-8 -ml-1 mt-1 sm:mt-5 lg:justify-start">
        ...
        <p className="h-0.5 w-2/3 bg-[#606060] mx-auto"></p>
